...
require.define("/script/todo.js",function(require,module,exports,__dirname,__filename,process,global){(function(module) {
...
require.define("/script/local.js",function(require,module,exports,__dirname,__filename,process,global){(function(module, localStorage, JSON) {
    _bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
    ...
    function store(name, ref) {
        ...
        if (value) {
            control.set(ref, JSON.parse(value));
        }
...
require.define("/script/bootstrap.js",function(require,module,exports,__dirname,__filename,process,global){// Application bootstrap
(function($, snuggle) {
